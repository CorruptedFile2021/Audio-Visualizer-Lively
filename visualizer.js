...
let glob = { bloom: true, bloomRadius: 101 };
...
function setSize() {
  ...
  gradient.createLinearGradient(rgb(255,255,255),rgb(200,200,200))
...
function livelyPropertyListener(name, val)
{
  switch(name) {
    case "lineColor":
      ...
      gradient.addColorStop(1, "rgb(199, 44, 93)");
      gradient.addColorStop(0, "rgb(214, 47, 47)");
      break;
  case "backgroundColor":
      ...
      gradient = ctx.createLinearGradient(0,0, canvas.width, 0);
      gradient.addColorStop(1, "rgb(199, 44, 93)");
      gradient.addColorStop(0, "rgb(26, 132, 219)");
